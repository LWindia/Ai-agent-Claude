...
export default function WhyCourseSection() {
  return (
    <section aria-label="Why This Program – Engineered for DevOps Engineers" className="py-14 px-4 relative overflow-hidden">
        ...
        <AnimatedSection>
          <div className="flex flex-col items-center mb-10">
            <SectionHeading
              ...
              title="Engineered for DevOps Engineers"
              highlight="DevOps Engineers"
              subtitle="Most courses teach you to chat with AI. This one teaches you to automate infrastructure with it."
            />
          </div>
        </AnimatedSection>
